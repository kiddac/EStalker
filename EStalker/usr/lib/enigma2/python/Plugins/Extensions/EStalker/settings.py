...
class EStalker_Settings(ConfigListScreen, Screen, ProtectedScreen):
    ALLOW_SUSPEND = True
    ...
    def initConfig(self):
        ...
        self.cfg_adult = getConfigListEntry(_("EStalker parental control"), cfg.adult)
        self.cfg_adultpin = getConfigListEntry(_("EStalker parental pin"), cfg.adultpin)
        ...
        self.cfg_subs = getConfigListEntry(_("Allow SubsSupport plugin in Movies. Restart GUI required"), cfg.subs)
